...
folder are mapped to the application's root namespace, 'Sencha_Draw'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Sencha_Draw"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Sencha_Draw' in the same way
as `"Sencha_Draw/sass/src"`.
