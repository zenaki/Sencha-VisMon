...
folder are mapped to the application's root namespace, 'VisualMoita'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "VisualMoita"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'VisualMoita' in the same way
as `"VisualMoita/sass/src"`.
