 ...
 * {@link Ext.Chart.ux.Highcharts.MapSerie} for details.
 * Finally, change the constructor
 * to ExtJs style as follows:
 *
 *     var map = Ext.Create('Ext.Chart.ux.Highmaps', {
 *         chartConfig {
 *              ....
 *         },
 *         series : [{
 ...
 *
 */
Ext.define("Ext.Chart.ux.Highmaps", {
    extend : 'Ext.Chart.ux.Highcharts',
    alias : ['widget.highmaps'],
    mixins: {
         observable: 'Ext.util.Observable'
    },
    basicSerieCls: "Ext.Chart.ux.Highcharts.MapSerie",
	...
	var HC = Ext.Chart.ux.Highcharts;
