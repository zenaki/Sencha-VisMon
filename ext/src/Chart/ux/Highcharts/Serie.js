 ...
 * series classes directly, they are created internally from Ext.Chart.ux.Highcharts depending on the
 ...
 *     }
 *
 * Then use {@link Ext.Chart.ux.Highcharts.Serie#cfg-dataIndex} to map the series data array
 *
 *     series: [{
 *         name: 'Series A',
 *         dataIndex: 'series1'
 ...
 */
Ext.define('Ext.Chart.ux.Highcharts.Serie', {
    requires: [ 'Ext.Chart.ux.Highcharts',
                'Ext.util.Observable'
              ],
    mixins: {
    ...
    /**
     * @readonly
     * The {@link Ext.Chart.ux.Highcharts} chart object owns this serie.
     * @type Object/Ext.Chart.ux.Highcharts
     *
	...
	var sencha = Ext.Chart.ux.Highcharts.sencha;
		 ...
		 * @param {Ext.Chart.ux.Highcharts.Serie}  serie the serie where is fired
    ...
    buildInitData:function(items, data) {
        ...
        if (Ext.Chart.ux.Highcharts.sencha.product == 't') {
