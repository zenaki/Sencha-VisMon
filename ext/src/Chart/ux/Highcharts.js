 ...
 *
 *       var chart = new Ext.create('Ext.Chart.ux.Highcharts', {
 *                       ....
 *                   });
 ...
 * to the desired {@link Ext.Chart.ux.Highcharts.Serie} class and {@link Ext.Chart.ux.Highcharts.Serie#method-getData}
 ...
 * {@link Ext.Chart.ux.Highcharts.Serie} class and {@link Ext.Chart.ux.Highcharts.Serie#cfg-dataIndex} configuration for
 ...
 * created without any datasets. However, the chart initial animation ({@link Ext.Chart.ux.Highcharts#cfg-initAnimAfterLoad})
 ...
 *          ...
 *      }
 * Once the chart is displayed, the dynamic series can be displayed via {@link Ext.Chart.ux.Highcharts#method-addSeries} method
 ...
 */
Ext.define("Ext.Chart.ux.Highcharts", {
    ...
    basicSerieCls: "Ext.Chart.ux.Highcharts.Serie",
     ...
     * A delay to call {@link Ext.Chart.ux.Highcharts#method-draw} method
     */
    updateDelay : 0,
...
console.log(record);
    ...
    /**
     * A function to delay the call to {@link Ext.Chart.ux.Highcharts#method-draw} method
